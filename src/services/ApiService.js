...
export default new (class ApiService {
  ...
  insertEmployee(data, primaryMgr) {
    return axios.post(`${INSERT_EMP_DETAILS_API_URL}?addressTypeId=${data.addTypeId}&departId=${data.departId}&desgId=${data.desgId}&subDepartId=${data.subDepartId}&subVId=${primaryMgr}&typeId=${data.empTypeId}`, data, auth())
  }
  ...
  supervisorId(id) {
    return axios.get(`${BASE_URL}/api/v1/drop-down/primary-manager-desig?desigId=${id}`, auth())
  }
  //edit employee
  ...
  primarydesgs(id) {
    return axios.get(`${BASE_URL}/api/v1/drop-down/all-employee-by-desig?desgId=${id}`, auth())
  }
  ...
  secondarymanagerpromote(lanceId, primaryId) {
    return axios.get(`${BASE_URL}/ReportsToSecondary/${lanceId}/${primaryId}`, auth())
  }

  // http://localhost:2022/ReportsToSecondary/{lanceId}/{primaryId}

  promoteEmp(emp_id, sub_id, sub_id2, newSalary) {
    return axios.get(`${BASE_URL}/PromoteEmpDetails/${emp_id}/${sub_id}/${sub_id2}/${newSalary}`, auth())
  }

  updatesalary(empId, salary, updateDate, data) {
    return axios.get(`${BASE_URL}/UpdateSalary/${empId}/${salary}/${updateDate}`, auth())
  }
  ...
  ReleaseEmpCmp(releaseDate, lancesoftId) {
    return axios.get(`${BASE_URL}/ReleaseEmp/${releaseDate}/${lancesoftId}`, auth())
  }
  ReleaseEmpCmps(releaseDate, lancesoftId) {
    return axios.get(`${BASE_URL}/TerminateEmp/${releaseDate}/${lancesoftId}`, auth())
  }
  ...
  abscondEmp(releaseDate, lancesoft) {
    return axios.get(`${BASE_URL}/AbscondEmp/${releaseDate}/${lancesoft}`, auth())
  }
  ...
  newprimarymanager(des_id, empId) {
    return axios.get(`${BASE_URL}/getPrimarySupervisor/${des_id}/${empId}`, auth())
  }
  ...
  newSecondarySupervisor(des_id, empId, superId) {
    return axios.get(`${BASE_URL}/getSecondarySupervisor?des_id=${des_id}&empId=${empId}&superId=${superId}`, auth())
  }
  ...
  promotedemoteEmp(Salary, emp_id, id1, id2, updated_date, newDesg) {
    return axios.get(`${BASE_URL}/submit/${emp_id}/${id1}/${id2}/${Salary}/${updated_date}/${newDesg}`, auth())
  }
  ...
  ShowEmployeesToDelete(desg_id) {
    return axios.get(`${BASE_URL}/api/v1/admin/ShowEmployeesToDelete/${desg_id}`, auth())
  }
  ...
  ShowEmployeesToDelete(empid) {
    return axios.get(`${BASE_URL}/api/v1/admin/ShowEmployeesToDelete/${empid}`, auth())
  }

  deleteEmployee(empId) {
    return axios.delete(`${BASE_URL}/api/v1/admin/DeleteEmployee?empId=${empId}&flag=${false}`, auth())
  }
  // api/v1/admin/DeleteEmployee?empId=2&flag=false
  deleteEmployeefor(empId) {
    return axios.delete(`${BASE_URL}/api/v1/admin/DeleteEmployee?empId=${empId}&flag=${true}`, auth())
  }
  // ChangePassword
