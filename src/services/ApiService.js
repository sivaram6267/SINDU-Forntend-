...
export default new (class ApiService {
  ...
  deleteEmployee(lancesoft) {
    return axios.delete(`${BASE_URL}/api/v1/admin/delete-employee/${lancesoft}/${false}`, auth())
  }
  deleteEmployeefor(lancesoft) {
    return axios.delete(`${BASE_URL}/api/v1/admin/delete-employee/${lancesoft}/${true}`, auth())
  }
})()
